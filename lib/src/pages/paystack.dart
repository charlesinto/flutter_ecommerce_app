...
String paystackPublicKey = pStackTest;
const String appName = 'Paystack Example';


class PayStackApp extends StatefulWidget {
  @override
  _PayStackAppState createState() => _PayStackAppState();
}

class _PayStackAppState extends State<PayStackApp> {
  @override
  void initState() {
    print('called');
  ...
  //   String paystackKey = pStackTest;
  //   try {
  //     await PaystackSDK.initialize(paystackKey);
  //   } catch(error){
  //     print("Error intializing Paystack key to $paystackKey");
  //   }
  // }
